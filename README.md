...
cd NOMBRE-DEL-FORK
3. Configurar el remoto original (upstream):
git remote add upstream https://github.com/Foxito777/Foxito777.github.io.git
git remote -v
...
7. Crear un Pull Request desde tu fork hacia el repositorio original
